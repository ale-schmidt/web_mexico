...
var RequestService = /** @class */ (function () {
    ...
    function RequestService(http) {
        ...
        this.url_base = "http://localhost:80/WEB_MEXICO/Mexico-WebAPI/"; // para probar aca
